...
Seven parameters: four disease betas (HIV, syph, NG, CT, TV), and two
network parameters. Condom effectiveness, rel_trans_primary,
rel_init_prev, p_symp, p_symp_care, and care-seeking rates are *fixed*
(set in model.py) per parameter-engineering analysis (exp 08).
