...
- exp 38 (2026-06-08): baseline partner notification added to all
  sims; opening pn.p_notify_stable and pn.p_notify_casual as priors
  so the calibration finds rates consistent with data. Also dropping
  four weak priors that showed max|r|<0.20 with sustained-cluster
  metrics in exp 34 (kept as fixed at model.py defaults):
