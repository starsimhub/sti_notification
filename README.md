...
Active calibration baseline: **exp 06** (500-draw LHS × K=5 sim-averaging, continuous weighted GoF, top-30 ensemble). Active scenario baseline: **65 cells × 10 draws × K=5 seeds = 3250 sims** (full factorial rerun 2026-07-22). See [`ANALYSIS_PLAN.md`](ANALYSIS_PLAN.md) for scope and endpoints.
