"""Exp 34 figures — hit-count, nontrep vs trep, HIV+ trep vs ratio,
...
ax.set_title(f'Exp 34 hit-count: {n_7plus}/300 pass 7+/9; {n_6} pass 6/9')
...
ax.set_title(f'Exp 34: no SUSTAINED draws in box ({n_in_box_sust}/{len(sust)})\n'
...
fig6.suptitle('Exp 34 — parameter region of the 5+/9 cluster vs all draws', y=1.01)
fig6.tight_layout()
