"""
Publication figures from the 200-draw final ensemble (exp 40).

Forked from exp 39 — only the ensemble size label changes. HIV
calibration is now in-band (exp 40 fix); syph absolute prev is still
off (the structural ceiling documented in exp 40 SUMMARY).
"""
...
ENSEMBLE_N = 200  # exp 40 robust draws
