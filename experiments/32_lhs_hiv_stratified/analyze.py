"""Exp 32 figures — hit-count, nontrep vs trep, HIV+ trep vs ratio,
...
ax.set_title('Exp 32 hit-count: 0/300 pass 7+/9; 2 pass 6/9')
...
# Panel 2: nontrep vs trep (parallel to exp 30)
...
ax.axvspan(0.01, 0.05, color='C2', alpha=0.15, label='relaxed nontrep band')
...
ax.set_title('Exp 32 — 300 draws: target box still empty')
...
fig6.suptitle('Exp 32 — parameter region of the 5+/9 cluster vs all draws', y=1.01)
fig6.tight_layout()
