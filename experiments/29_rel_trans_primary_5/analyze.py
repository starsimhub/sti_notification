"""Per-seed trajectory figure for exp 29."""
import pickle
...
axes[0].axhspan(0.20, 0.40, color='C2', alpha=0.2, label='target')
...
fig.suptitle('Exp 29 — rel_trans_primary=5 + dur_early=22-24mo: 1/3 seeds stable, 2/3 collapse')
fig.tight_layout()
